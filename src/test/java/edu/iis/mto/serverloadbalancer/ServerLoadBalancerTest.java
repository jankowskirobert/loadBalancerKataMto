...
public class ServerLoadBalancerTest {
	...
	public void balancingServerWithNoVms_serverStaysEmpty() {
		...
		balancig(aServerListWith(theServer), anEmptyListOfVms());
	...
	public void vmsShouldBeBalancedOnLessLoadedServerFirst() {
		...
		balancig(aServerListWith(moreLoadedServer, lessLoadedServer), aVmsListWith(theVm));
	...
	public void balancingServersAndVms() {
		...
		balancig(aServerListWith(server1, server2), aVmsListWith(vm1, vm2, vm3));
	...
	private void balancig(Server[] servers, Vm[] vms) {
